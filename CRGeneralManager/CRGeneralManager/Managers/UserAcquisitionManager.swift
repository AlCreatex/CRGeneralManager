...
open class UserAcquisitionManager: NSObject {
    ...
    public struct Url {
        ...
        public static let inapps    = Url(rawValue: "https://api.inapps.io/v2")
        public static let subr      = Url(rawValue: "https://api.subr.app/v2")
        public static let chkmob    = Url(rawValue: "https://api.chkmob.com/v2")
        public static let bittiu    = Url(rawValue: "https://api.bittiu.com/v2")
        public static let trklabs   = Url(rawValue: "https://api.trklabs.com/v2")
        public static let devpng    = Url(rawValue: "https://api.devpng.com/v2")
        public static let pingfront = Url(rawValue: "https://api.pingfront.com/v2")
    ...
    public func configure(withAPIKey APIKey: String, urlRequest: Url = .inapps) {
